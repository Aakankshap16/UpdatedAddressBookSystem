namespace Updated_AddressBookSystem
{
    public class ReadTxtFile
    {
        public static void SaveContactsToFile(List<Contact> contactList)
        {
            ...
            using (StreamWriter writer = File.AppendText("C:\\Users\\ASHISH PANDEY\\source\\repos\\Updated_AddressBookSystem\\Exampe1.txt"))  //DIRECTLY GIVEN PATH
            {
        ...
        public static void LoadContactsFromFile(List<Contact> contactList)
        {
            ...
            string path = "C:\\Users\\ASHISH PANDEY\\source\\repos\\Updated_AddressBookSystem\\Exampe1.txt"; //FIRST ASSIGN PATH TO VARIABLE THEN PASS
